...
$$($(1)_TARGET): APP_CFLAGS := $$(filter-out -Wall, $(CFLAGS)) -Waddress  -Waggregate-return \
	...
	-Wdisabled-optimization -Wno-div-by-zero -Wdouble-promotion -Wempty-body \
	-Wenum-compare -Wno-endif-labels -Werror -Wfloat-equal -Wformat -Wformat=2 \
	-Wno-format-contains-nul -Wno-format-extra-args -Wformat-nonliteral \
	-Wformat-security -Wformat-y2k -Wjump-misses-init -Wignored-qualifiers \
...
$$($(1)_TARGET): $$(APPS_STD_TARGET) $$($(1)_OBJS) build/apps.mk
	...
	$$(LD) $$(LDFLAGS) -T build/apps.lds -o $$@.elf $$(filter-out build/apps.mk, $$(filter-out $$<, $$^)) $(OUTPUT)/libstd.a
